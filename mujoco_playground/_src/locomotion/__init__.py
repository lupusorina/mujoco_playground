...
from mujoco_playground._src.locomotion.biped import joystick as biped_joystick
from mujoco_playground._src.locomotion.biped import randomize as biped_randomize
...
_envs = {
    ...
    "BipedJoystickFlatTerrain": functools.partial(
        biped_joystick.Joystick, task="flat_terrain"
    ),
    "BipedJoystickRoughTerrain": functools.partial(
        biped_joystick.Joystick, task="rough_terrain"
    ),
...
_cfgs = {
    ...
    "BipedJoystickFlatTerrain": biped_joystick.default_config,
    "BipedJoystickRoughTerrain": biped_joystick.default_config,
...
_randomizer = {
    ...
    "BipedJoystickFlatTerrain": biped_randomize.domain_randomize,
    "BipedJoystickRoughTerrain": biped_randomize.domain_randomize,
